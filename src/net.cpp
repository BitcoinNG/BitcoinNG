...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BitcoinNG " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"btcng.de", "dnsseed.btcng.de"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"btcng.de", "testnet-seed.btcng.de"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitcoinNG is probably already running."), addrBind.ToString().c_str());
        else
